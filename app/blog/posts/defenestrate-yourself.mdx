---
title: 'Defenestrate Yourself and Face to Crudshed'
...
```
You stand on the city of disaster, the Beast City, where the Biological Intelligence in Artificial System, what we call "BIAS" locates. Nobody knows about what has been going on "BIAS." You could hear nothing but deep breathing of "BIAS." The only way to survive is…

DEFENESTRATE YOURSELF AND FACE TO CRUDSHED.
```
